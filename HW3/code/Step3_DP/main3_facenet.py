...
def main():
    ...
    # Map directory name to actual path
    def get_path(name):
        if name == 'clear':
            return CLEAR_DIR
        elif name == 'blurred':
    ...
    # Set output filenames dynamically
    embedding_save_path = f"./facenet_model/facenet_embeddings_{args.train_dir}.npz"
    classifier_save_path = f"./facenet_model/knn_classifier_{args.train_dir}.pkl"
